...
server <- function(input, output) {
  ...
  getData <- reactive({
    ...
    # spc=cor.test( ~ y + regression_factors1,
    #               data=reg_data,
    #               method = "spearman",
    #               continuity = FALSE,
    #               conf.level = 0.95)
    # test_data_sheet$spc_factor1[i]=spc$estimate[[1]]
    # spc=cor.test( ~ y + regression_factors2,
    #               data=reg_data,
    #               method = "spearman",
    #               continuity = FALSE,
    #               conf.level = 0.95)
    # test_data_sheet$spc_factor2[i]=spc$estimate[[1]]
    # 
    # 
    # spc=cor.test( ~ y + regression_factors3,
    #               data=reg_data,
    #               method = "spearman",
    #               continuity = FALSE,
    #               conf.level = 0.95)
    # test_data_sheet$spc_factor3[i]=spc$estimate[[1]]
    # 
    # 
    # 
    # pearc=cor.test( ~ y + regression_factors1,
    #                 data=reg_data,
    #                 method = "pearson",
    #                 continuity = FALSE,
    #                 conf.level = 0.95)
    # test_data_sheet$pearc_factor1[i]=pearc$estimate[[1]]
    # 
    # pearc=cor.test( ~ y + regression_factors2,
    #                 data=reg_data,
    #                 method = "pearson",
    #                 continuity = FALSE,
    #                 conf.level = 0.95)
    # test_data_sheet$pearc_factor2[i]=pearc$estimate[[1]]
    # 
    # pearc=cor.test( ~ y + regression_factors3,
    #                 data=reg_data,
    #                 method = "pearson",
    #                 continuity = FALSE,
    #                 conf.level = 0.95)
    # test_data_sheet$pearc_factor3[i]=pearc$estimate[[1]]
    ...
    #sx.use$AUC[i] <- sum(diff(x[id])*rollmean(y[id],2))
    }

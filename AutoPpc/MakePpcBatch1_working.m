function MakePpcBatch1_working(SpmDir, SubID, SubP, CodeDir, PpcBatchDir, Func, Fmap, Defaults)
%
...
if length(CurFDirs)==2
    ...
    save(fullfile(CodeDir,strcat(SubID,'_Func1Ppc_',Func,'.mat')),'matlabbatch');

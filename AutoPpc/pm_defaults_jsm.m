%%
% EVERYTHING I KNOW ABOUT FIELDMAPS COMES FROM THIS PAGE: 
...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and 
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 4.92;        % Short echo time in ms for Allegra
pm_def.LONG_ECHO_TIME = 7.38;        % Long echo time in ms for Allegra
...
pm_def.TOTAL_EPI_READOUT_TIME = 30.08;   % Allegra EPI RO time (330E-6*64)

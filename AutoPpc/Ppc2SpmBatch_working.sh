...
date 
matlab -nosplash -nodisplay -nodesktop -softwareopengl -r "SpmDir= '$1' ; SubID= '$2' ;  SubP= '$3' ; CodeDir= '$4' ; PpcBatchDir = '$5' ; Func = '$6' ; Struct = '$7' ; MakePpcBatch1(SpmDir, SubID, SubP, CodeDir, PpcBatchDir, Func, Fmap, Defaults); quit"

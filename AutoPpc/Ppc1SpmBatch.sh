...
#
echo ---------------------------------------------------------
echo Ppc pt1 $SubID $6
date 
matlab -nosplash -nodisplay -nodesktop -softwareopengl -r "SpmDir= '$1' ; SubID= '$2' ;  SubP= '$3' ; CodeDir= '$4' ; PpcBatchDir = '$5' ; Func = '$6' ; Fmap = '$7' ; Defaults = '$8' ; MakePpcBatch1(SpmDir, SubID, SubP, CodeDir, PpcBatchDir, Func, Fmap, Defaults); quit"
# matlab -softwareopengl -r "SpmDir= '$1' ; SubID= '$2' ;  SubP= '$3' ; CodeDir= '$4' ; PpcBatchDir = '$5' ; Func = '$6' ; Fmap = '$7' ; Defaults = '$8' ; MakePpcBatch1_working(SpmDir, SubID, SubP, CodeDir, PpcBatchDir, Func, Fmap, Defaults)"
echo Ppc pt1 $SubID $6 DONE!
date 
echo ---------------------------------------------------------
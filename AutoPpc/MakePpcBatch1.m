...
try
    ...
    % Find out how many runs of the functional task there are
    CurFDirs=dir(fullfile(SubP,strcat(Func,'*')));
    % If there are two, do things this way
    if length(CurFDirs)==2
        ...
        % Now, if there aren't any fieldmaps, do things this way
        if isempty(Fmap0_1) | isempty(Fmap1_1)
            ...
            matlabbatch{2}.spm.spatial.realignunwarp.data(1).pmscan(1) = {''};
            ...
            matlabbatch{2}.spm.spatial.realignunwarp.data(2).pmscan(1) = {''};
            matlabbatch{2}.spm.spatial.realignunwarp.eoptions.quality = 1;
            matlabbatch{2}.spm.spatial.realignunwarp.eoptions.sep = 3;
    ...
    elseif length(CurFDirs)==1
        ...
        if isempty(Fmap0_1)
            ...
            matlabbatch{2}.spm.spatial.realignunwarp.data.pmscan(1) = {''};
            matlabbatch{2}.spm.spatial.realignunwarp.eoptions.quality = 1;
            matlabbatch{2}.spm.spatial.realignunwarp.eoptions.sep = 3;
            matlabbatch{2}.spm.spatial.realignunwarp.eoptions.fwhm = 5;
            matlabbatch{2}.spm.spatial.realignunwarp.eoptions.rtm = 1;
